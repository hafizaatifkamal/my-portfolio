...
import imageSrc from "@/assets/images/profile_linkedin.jpg";
      ...
      <div className="container mx-auto flex flex-col md:flex-row items-center text-center">
        ...
        <div className="w-2/3 p-4">
          <p className="text-base md:text-lg text-gray-600">
            ...
            delivering end-to-end product solutions for over 2+ years.
            Proficient in API designing, UI development, and seamless deployment
            ...
            exceed customer expectations. Seeking new challenges to leverage my
            skills and contribute to cutting-edge projects focusing on
